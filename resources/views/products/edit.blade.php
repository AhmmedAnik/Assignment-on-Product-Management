...
<div class="container mx-auto px-4">
    ...
    <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6 bg-white p-6 rounded-lg shadow-lg">
        @csrf
        @method('PUT')
    ...
    <a href="{{ route('products.index') }}" class="inline-block mt-6 border text-center mb-8 p-2 border-blue-500 text-blue-500 hover:underline">Back to Products</a>
</div>
@endsection
